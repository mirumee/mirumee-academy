...
export type DemoFilmsQueryVariables = Exact<{ [key: string]: never; }>;


export type DemoFilmsQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', films?: Array<{ __typename?: 'Film', id: string, title?: string | null } | null> | null } | null };

export type FilmsQueryVariables = Exact<{ [key: string]: never; }>;


export type FilmsQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', films?: Array<{ __typename?: 'Film', id: string, title?: string | null, planetConnection?: { __typename?: 'FilmPlanetsConnection', planets?: Array<{ __typename?: 'Planet', id: string, name?: string | null, diameter?: number | null, rotationPeriod?: number | null, orbitalPeriod?: number | null, population?: number | null, surfaceWater?: number | null, climates?: Array<string | null> | null } | null> | null } | null } | null> | null } | null };


export const DemoFilmsDocument = `
    query DemoFilms {
  allFilms {
    films {
      id
    ...
    `;
export const useDemoFilmsQuery = <
      TData = DemoFilmsQuery,
      TError = unknown
    >(
      variables?: DemoFilmsQueryVariables,
      options?: UseQueryOptions<DemoFilmsQuery, TError, TData>
    ) =>
    useQuery<DemoFilmsQuery, TError, TData>(
      variables === undefined ? ['DemoFilms'] : ['DemoFilms', variables],
      fetcher<DemoFilmsQuery, DemoFilmsQueryVariables>(DemoFilmsDocument, variables),
      options
    );
...
export const useFilmsQuery = <
      ...
      TError = unknown
    >(
      variables?: FilmsQueryVariables,
      options?: UseQueryOptions<FilmsQuery, TError, TData>
    ) =>
    useQuery<FilmsQuery, TError, TData>(
      variables === undefined ? ['Films'] : ['Films', variables],
      fetcher<FilmsQuery, FilmsQueryVariables>(FilmsDocument, variables),
      options
    );